namespace NumbersToWords
{
    ...
    public class NumbersToWords
    {
        ...
        public static string Letterize(int num)
        {
            if (num < -999)
            {
                return "too small";
        ...
        public static string DigitToWord(int lastDigit)
        {
        ...
        public static string DigitToTensWord(int secondDigit)
        {
        ...
        public static string DigitToTeenNumberWord(int lastPart)
        {
            string lastPartString;
            switch (lastPart)
            {
