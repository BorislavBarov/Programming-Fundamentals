namespace PriceChangeAlert
{
    ...
    public class PriceChangeAlert
    {
        ...
        public static string GetAlertMessage(double currentPrice, double previousPrice, double difference, bool isSignificantDifference)
        {
        ...
        public static bool IsDifferenceSignificant(double difference, double threshold)
        {
        ...
        public static double CalculateDifference(double previousPrice, double currentPrice)
        {
